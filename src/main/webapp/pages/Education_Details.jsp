...
<div class="signup-form">
    <form:form action="btneducationdetails" method="POST" modelAttribute="educationdetails">
    <form:hidden path="pid"/> 
        ...
        <div class="form-group">
        	<form:select path="highest_degree" class="form-control" type="text" >
        <form:option value=""> ---Select Degree--</form:option>
        <form:options items="${degreelist}"/>
        </form:select>
        </div>
        <div class="form-group">
        	<form:select path="university"  class="form-control" type="text" >
        ...
        <form:options items="${alluniversity}"/>
         ...
         <div class="form-group">
        	<form:select path="year"  class="form-control" type="text" >
        ...
        <div class="row">
				<div class="col-xs-6">
		<div class="">
                    <a href="/?pid=${educationdetails.pid}" id="forgot" >Previous?</a>
        </div>
            </div>
				<div class="col-xs-6">
		<div class="form-group">
